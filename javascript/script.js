...
function updateTimer() {
  const targetDate = new Date("november 23, 2025 12:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543815829288'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543815829288'; // Número para el primer botón
  const recipientNumber2 = '543547639491'; // Número para el segundo botón
  const recipientNumber3 = '543547674847'; // Número para el tercer botón
  ...
  document.getElementById('botoncito3').addEventListener('click', function () {
